...
export default function Typographit() {
  return (
    <div className={style.container}>
      ...
      <div className={styles.headingOverview}>
        ...
        <div className={styles.heading}>
          ...
          <h1>Concepting a font management system</h1>

          <h6 className={styles.caps}>Personal Project, 2021</h6>
      ...
      <div className={styles.headerImage}>
        ...
        <Image src={typeDisplay} alt={"Display Image showing a mobile UI screen for Givelify's apps"} height="1600" width="2800" layout="responsive" objectFit="cover"/>
